...
public extension UIDevice {
    ...
    public func ows_setOrientation(_ orientation: UIInterfaceOrientation) {
        // XXX - This is not officially supported, but there's no other way to programattically rotate
        // the interface. You can call `UINavigationController.attemptRotationToDeviceOrientation`
